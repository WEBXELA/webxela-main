...
import { Smartphone, ChevronRight, ArrowRight, CheckCircle2, Apple, Cuboid as Android, Laptop, Gauge, Shield, Clock, Sparkles, Zap, Share2, LineChart, Code, Layers } from 'lucide-react';

const AppDevSolutionsPage = () => {
  const solutions = [
    {
      title: "iOS Development",
      description: "Create stunning native iOS applications with cutting-edge features.",
      icon: Apple,
      color: "#6366F1",
      features: [
        "Swift & SwiftUI",
    ...
    },
    {
      ...
      description: "Build powerful Android applications with modern architecture.",
      icon: Android,
      color: "#8B5CF6",
      features: [
        "Kotlin Development",
    ...
    },
    {
      ...
      description: "Robust architecture ensuring scalability and maintainability.",
      icon: Layers,
      color: "#10B981",
      features: [
        "Clean Architecture",
  ...
  const features = [
    ...
    },
    {
      ...
      description: "Built-in usage tracking",
      icon: LineChart,
      color: "#F97316"
    },
    {
    ...
    <div className="min-h-screen bg-white pt-20">
      ...
      <section className="relative overflow-hidden py-20 lg:py-32">
        ...
        >
          ...
          <div className="absolute inset-0 bg-[url('https://images.unsplash.com/photo-1512941937669-90a1b58e7e9c?auto=format&fit=crop&q=80&w=2070')] opacity-5" />
        </motion.div>
        ...
        <div className="max-w-7xl mx-auto px-4 relative z-10">
          ...
          >
            ...
            >
              <Smartphone className="w-10 h-10 text-[#2A2AE1]" />
            </motion.div>
            <h1 className="text-5xl md:text-7xl font-bold mb-8">
              Mobile App
              <span className="block text-gradient">Development Solutions</span>
            </h1>
            <p className="text-xl text-gray-600 mb-12">
              Create exceptional mobile experiences with our comprehensive app development
              services. From native to cross-platform, we deliver excellence on every platform.
            </p>
            <motion.div
        ...
        <div className="max-w-7xl mx-auto px-4">
          ...
          >
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Our mobile solutions are engineered for performance, security, and user experience
            </p>
          </motion.div>
      ...
      <section className="py-20 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4">
          ...
          >
            <h2 className="text-4xl font-bold mb-6">
              Why Choose Our <span className="text-gradient">Mobile Solutions</span>
            </h2>
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Experience the benefits of our enterprise-ready mobile development platform
            </p>
          </motion.div>
...
export default AppDevSolutionsPage;