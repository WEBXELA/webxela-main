...
const WebDevSolutionsPage = () => {
  const solutions = [
    {
      title: "Frontend Development",
      description: "Create stunning user interfaces with modern frameworks and technologies.",
      icon: Layout,
      color: "#6366F1",
      features: [
    ...
    },
    {
      ...
      description: "Build powerful online stores and digital marketplaces.",
      icon: Share2,
      color: "#10B981",
      features: [
        "Custom E-commerce",
  ...
  const features = [
    ...
    {
      title: "Analytics",
      description: "Built-in performance tracking",
      icon: LineChart,
      color: "#10B981"
    }
  ];
    ...
    <div className="min-h-screen bg-white pt-20">
      ...
      <section className="relative overflow-hidden py-20 lg:py-32">
        ...
        >
          ...
          <div className="absolute inset-0 bg-[url('https://images.unsplash.com/photo-1467232004584-a241de8bcf5d?auto=format&fit=crop&q=80&w=2070')] opacity-5" />
        </motion.div>
        ...
        <div className="max-w-7xl mx-auto px-4 relative z-10">
          ...
          >
            ...
            >
              <Code className="w-10 h-10 text-[#2A2AE1]" />
            </motion.div>
            ...
            <p className="text-xl text-gray-600 mb-12">
              Create stunning, high-performance web applications with our comprehensive
              development services. From frontend to backend, we deliver excellence.
            </p>
            <motion.div
        ...
        <div className="max-w-7xl mx-auto px-4">
          ...
          >
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Our web solutions are engineered for speed, security, and scalability
            </p>
          </motion.div>
      ...
      <section className="py-20 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4">
          ...
          >
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Experience the benefits of our enterprise-ready web development platform
            </p>
          </motion.div>
          ...
          >
            ...
            <div className="relative z-10">
              ...
              <p className="text-xl mb-8 text-white/90 max-w-3xl mx-auto">
                Let's discuss how we can help you create an exceptional web experience
              </p>
              <motion.button
...
export default WebDevSolutionsPage;